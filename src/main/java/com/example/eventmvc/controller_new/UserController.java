...
//    }
//@GetMapping("/myhtml")
//public String myhtml(ModelMap modelMap,
//                     @AuthenticationPrincipal UserDetails userDetails){
//    modelMap.addAttribute("login_user", new User());
//    modelMap.addAttribute("isLoggedIn", userDetails != null);
//    if(userDetails!=null){
//    modelMap.addAttribute("currentUser", userRepository.findAllByUsername(userDetails.getUsername()));}
...
//                          @ModelAttribute User user, @RequestParam(name = "picture") MultipartFile multipartFile) throws IOException {
//
...
//    public void getImageAsByteArray(HttpServletResponse response,HttpServletRequest httpServletRequest,
