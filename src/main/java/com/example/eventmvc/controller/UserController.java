...
//    private UserNotificationRepository userNotificationRepository;
    ...
    public String index(ModelMap modelMap,
                        @AuthenticationPrincipal UserDetails userDetails,HttpServletResponse httpServletResponse, HttpServletRequest httpServletRequest) {
//        httpServletResponse.setIntHeader("Refresh",4);
